...
async function checkHttp() {
  ...
  try {
    ...
    const pages = ["/", "/ui-lab.html", "/ui-frameworks.html", "/map-grid-layout-test.html", "/map-layer-test.html", "/map-building-visibility-test.html", "/map-building-anchor-preview.html", "/map-game-ui-preview.html"];
